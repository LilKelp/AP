# User Docs Index
- Overview: read AGENTS.md and STATE.md to understand current process and constraints.
- Tool guides: see docs/user/tools/ for per-tool instructions.
- Output locations: keep all artifacts under 03-outputs/<tool>/... and include paths when sharing results.
